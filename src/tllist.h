#ifndef TLLIST_H_INCLUDE
#define TLLIST_H_INCLUDE
...
#define tll_foreach(list, it)                                                  \
  for (__typeof__(*(list).head) *it = (list).head,                             \
       ...
       it != NULL;                                                             \
       it = it_next, it_next = it_next != NULL ? it_next->next : NULL)
...
#define tll_rforeach(list, it)                                                 \
  for (__typeof__(*(list).tail) *it = (list).tail,                             \
       ...
       it != NULL;                                                             \
       it = it_prev, it_prev = it_prev != NULL ? it_prev->prev : NULL)
...
#define tll_free(list)                                                         \
  do {                                                                         \
    tll_foreach(list, __it) free(__it);                                        \
    (list).length = 0;                                                         \
